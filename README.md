...
| `WS_STALE_AFTER_MS` | Ms sin actividad del cliente antes de cerrar un WS de oyente/broadcaster (por defecto 300000, mínimo 30000, máximo 10800000 = 3 h). En Render se usa 10800000 para que el emisor en Android en segundo plano no se corte a los 15 min. |
| `LISTENER_BACKGROUND_GRACE_MS` | Ms durante los que un oyente sigue contando en el panel aunque el WebSocket se haya cortado (p. ej. Android en segundo plano con audio activo; por defecto 10800000 = 3 h, mínimo 60000, máximo 10800000). |
